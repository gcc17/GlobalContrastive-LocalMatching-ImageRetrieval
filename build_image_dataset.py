...
flags.DEFINE_string('train_directory', 'test/0/0/0', 'Training data directory.')
flags.DEFINE_string('test_directory', 'test/0/0/0',
...
flags.DEFINE_string('train_csv_path', 'test/test.csv',
...
flags.DEFINE_string('test_csv_path', 'test/test.csv',

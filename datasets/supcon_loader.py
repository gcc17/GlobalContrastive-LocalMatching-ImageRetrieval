...
from datasets.supcondataset import SupconDataSet
...
def _construct_loader(dataset_name, split, batch_size, shuffle, drop_last):
    """Constructs the supervised contrastive data loader for the given dataset."""
    data_path = os.path.join(_DATA_DIR, dataset_name)
    # Construct the dataset
    dataset = SupconDataSet(data_path, split)
